...
import BookDetailsModal from "../modal/BookDetails";
    ...
    return (
      <div className="min-h-screen flex flex-col">
        <main className="flex-1 bg-gray-50 flex items-center justify-center">
          <p className="text-base sm:text-lg text-gray-600 px-4 text-center">Loading book details...</p>
        </main>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex flex-col">
        <main className="flex-1 bg-gray-50 flex items-center justify-center p-4">
          <div className="text-center max-w-md">
            ...
            <button
              onClick={handleBack}
              className="text-blue-600 hover:text-blue-800 flex items-center justify-center space-x-1 sm:space-x-2 mx-auto"
            >
              <ArrowLeft size={16} />
      ...
      <main className="flex-1 bg-gray-50">
        <div className="px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 pt-4 sm:pt-6 pb-6 sm:pb-8">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Book Details</h1>
          </div>

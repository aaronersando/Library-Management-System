...
function NavBar(){
    ...
    return(
        <>
            <nav className="flex flex-row place-content-between px-5 sm:px-20 md:px-30 lg:px-45 pt-5 pb-3 shadow-sm">
                ...
                <div className="flex flex-row space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-6">
                    ...
                    <button className="bg-blue-500 text-md text-white font-normal px-4 rounded-md py-1.5 -mt-1.5">Add Book</button>
                </div>
            </nav>
        </>
    )
